...
responses=["Music is so relaxing!","Dogs are man's best friend!", "I know a lot about books", "I like to play video games"]
...
while user != "bye":
    ...
    if not keyword_found:
        ...
        break  # Exit the loop after adding the new keyword and response.
